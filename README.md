...
### /api/threads/{BOARD}/catalog/{[1-9]+ OR full}.json
https://kissu.moe/api/threads/b/catalog/full.json <br/>
Information about the given catalog is stored in partial forms or the full form. The partial is split up into chunks of 60 threads each.
